...
const init_phones = ["Δ JM-1 DF Target", "nova green y2 velvet"],// Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      rig_description = "SPL Calibrated Clone IEC 60318-4 Coupler at 94dB (+-1dB) SPL@1kHz",
...
const targets = [
    { type:"Δ",    files:["Δ ISO 11904-1 DF", "Δ JM-1 DF","Δ 5128 DF","IEF Comp"] },
    { type:"Community",   files:["IEF Neutral 2023","IEF Neutral 2020"] },
    { type:"Preference", files:["Harman IE 2019 v2","Harman IE 2017 v2","Harman IE 2016"] }
];
...
const  preference_bounds_name = "Bounds",  // Preference bounds name
       ...
       default_DF_name = "Δ ISO 11904-1 DF",                   // Default RAW DF name
       ...
       tiltableTargets = ["Δ ISO 11904-1 DF", "Δ JM-1 DF","Δ 5128 DF"],                 // Targets that are allowed to be tilted
       compTargets = ["Δ ISO 11904-1 DF", "Δ JM-1 DF","Δ 5128 DF"],                     // Targets that are allowed to be used for compensation
       compensateMeasurementByDefault = false,         // If true, measurement is compensated by default
       default_comp_target = "Δ JM-1 DF",               // Default compensation target. (Choose one from 'compTargets'. This maybe useful if you have IEF Compensation Data.)
